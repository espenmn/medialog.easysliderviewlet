...
def setup_product():
    ...
    zcml.load_config('configure.zcml', medialog.easysliderviewlet)
    ...
    ztc.installPackage('medialog.easysliderviewlet')
...
setup_product()
ptc.setupPloneSite(products=['medialog.easysliderviewlet'])
